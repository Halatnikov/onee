...
function ProFi:onFunctionCall( funcInfo )
	...
	funcReport.name = funcInfo.name or 'anonymous'
	funcReport.source = funcInfo.short_src or funcInfo.source or '[C]'
	funcReport.linedefined = funcInfo.linedefined or 0
