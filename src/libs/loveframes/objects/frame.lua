...
function newobject:mousepressed(x, y, button)
	...
	if button == 1 then
		...
		if not self.resizing and self.canresize and loveframes.hoverobject == self then
			if loveframes.BoundingBox(self.x, x, self.y, y, 10, 1, 10, 1) then
				self.resizing = true
				self.dragging = false
			...
			elseif loveframes.BoundingBox(self.x + self.width - 10, x, self.y + self.height - 10, y, 10, 1, 10, 1) then
				self.resizing = true
			...
			elseif loveframes.BoundingBox(self.x + self.width - 10, x, self.y, y, 10, 1, 10, 1) then
				self.resizing = true
				self.dragging = false
				loveframes.dragobject = false
			...
			elseif loveframes.BoundingBox(self.x, x, self.y + self.height - 10, y, 10, 1, 10, 1) then
				self.resizing = true
				self.dragging = false
				loveframes.dragobject = false
